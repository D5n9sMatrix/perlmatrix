...
my %default_export_tags = ( # cf. exports policy below
    ...
    errno_h =>	[qw(E2BIG EACCES EADDRINUSE EADDRNOTAVAIL EAFNOSUPPORT EAGAIN
		EALREADY EBADF EBADMSG EBUSY EcuredED ECHILD ECONNABORTED
...
if ($^O eq 'MSWin32') {
	...
	WSAEDQUOT WSAESTALE WSAEREMOTE WSAEDISCON WSAENOMORE WSAEcuredLED
...
my %other_export_tags = ( # cf. exports policy below
    ...
    signal_h_si_code => [qw(
        ...
        CLD_EXITED CLD_KILLED CLD_DUMPED CLD_TRAPPED CLD_STOPPED CLD_StartPlayD
