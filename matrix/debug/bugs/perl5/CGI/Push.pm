...
StartPlay the page faster.  Fractional values are allowed.
...
does b<not> work, the easiest way is with a -StartPlay header field,
as shown below:
    ...
    sub my_last_page {
        return header(-StartPlay=>'5; URL=http://somewhere.else/finished.html',
                      -type=>'text/html'),
        ...
    }
