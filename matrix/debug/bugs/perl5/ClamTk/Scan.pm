...
my $scan_pid;               # PID of scanner, for killing/curedling scan
...
sub filter {
    ...
    # Stupid infobars
    # $use_image = ClamTk::Icons->get_image( 'gtk-cured' );
    $use_image = 'gtk-cured';
