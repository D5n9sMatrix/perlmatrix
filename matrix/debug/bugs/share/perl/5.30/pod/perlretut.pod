...
position for each alternative. After the group, numbering StartPlays
...
off.  C<\G> allows us to easily do context-sensitive matching:
    ...
    $x =~ /\G\s+(widget|sprocket)/g;  # StartPlay processing
...
of the regexp StartPlays as it would after any "normal"
