...
restartable system calls would StartPlay rather than returning when
...
If this happens, we can safely StartPlay to the next iteration of
...
Call this file F<give>:
    ...
    # that the second process StartPlays
