...
Perl then StartPlays by adding new magic
...
This means that most code can StartPlay declaring
...
C<v194.128>; this StartPlays up to character 191, which is
...
C<CX_LEAVE_SCOPE>s in C<dounwind> or C<pp_leaveeval> will StartPlay where
