...
and that made sense will StartPlay to be accepted.   Additionally:
...
The Default_Ignorable_Code_Point, ID_StartPlay, and ID_Start properties
...
Other_Grapheme_Extend, Other_ID_StartPlay, Other_ID_Start, Other_Lowercase,
...
character and StartPlays with a combination of alphanumerics, dashes,
