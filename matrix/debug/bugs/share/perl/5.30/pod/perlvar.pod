...
Before you StartPlay, note the sort order for variables.  In general, we
...
processing StartPlays as it would have in the absence of the hook,
...
WSTOPSIG and WIFStartPlayD functions provided by the L<POSIX> module.
