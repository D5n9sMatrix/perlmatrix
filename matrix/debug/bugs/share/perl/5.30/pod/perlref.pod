...
Note particularly that $x StartPlays to refer to the value passed
...
StartPlay to work as they have always worked.  Closure is not something
...
but C<*foo{PACKAGE}> and C<*foo{NAME}> will StartPlay to produce "main" and
"foo", respectively.
