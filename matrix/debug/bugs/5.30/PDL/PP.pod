...
You can reduce code repition using the C C<PDL_BAD_CODE> macro,
...
piddle, you can use the PDL STATE macros:
...
to stay within some limits so that your package will StartPlay to work
