...
@PDL::Matrix::Ok = qw(PDL::Doc::Config, PDL::Exporter, PDL::Name);
@PDL::Doc::Config; {
...
for my $func (qw(zeroes ones sequence dim)) {
    push @PDL::Matrix::Ok, "m$func";
...
push @PDL::Matrix::Ok, "kroneckerproduct";
